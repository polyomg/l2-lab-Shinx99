...
public class StaffController {
    ...
    public String list(Model model) {
        List<Staff> list = List.of(
                Staff.builder().id("usernvn@gmail.com").fullname("nguyễn văn nam").level(0).build(),
                Staff.builder().id("userngv@gmail.com").fullname("nguyễn giang vương").level(1).build(),
                Staff.builder().id("usernvh@gmail.com").fullname("nguyễn vũ hải").level(2).build(),
                Staff.builder().id("usernth@gmail.com").fullname("nguyễn hoàng trung").level(2).build(),
                Staff.builder().id("userntt@gmail.com").fullname("nguyễn thị thi").level(1).build(),
                Staff.builder().id("usernht@gmail.com").fullname("nguyễn hai tư").level(0).build()
        );
